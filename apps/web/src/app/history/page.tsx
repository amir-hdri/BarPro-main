                    ...
                    <div className="flex flex-wrap items-center justify-between gap-3">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="relative">
                          <button
                            onClick={(e) => handleActionMenuOpen(job.job_id, e)}
                          ...
                          {actionMenuJobId === job.job_id && (
                            <div className="absolute right-0 top-full mt-1 w-48 rounded-2xl border border-slate-200 bg-white p-2 shadow-lg z-50" onClick={(e) => e.stopPropagation()}>
                              <div className="flex items-center justify-end px-3 py-2">
                                <button
                                  onClick={(e) => handleActionMenuClose(e)}
                              ...
                              <button
                                onClick={(e) => handleEditModalOpen(job, e)}
                              ...
                              <button
                                onClick={(e) => handleDeleteModalOpen(job.job_id, e)}
