                ...
                with open('.env', 'r') as f:
                    for line in f:
                        ...
                        if any(line.startswith(prefix) for prefix in [
                            "FRONTEND_URL", "NEXT_PUBLIC_API_URL", "AVAILABLE_IP_INDICES",
                            "WORKER_1_PROXY", "WORKER_2_PROXY", "WORKER_3_PROXY", "ENVIRONMENT"
                        ]):
                            continue
                        env_content += line
...
def main():
    ...
    parser.add_argument("--choice", type=int, choices=[1, 2, 3], default=3,
                        help="1: Proxy only, 2: Main app only, 3: Both (default)")
