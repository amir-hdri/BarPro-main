...
GUIDE_ROWS = [
    ...
    [
        "آدرس فرستنده",
        "توصیه‌شده",
        "آدرس متنی محل بارگیری؛ اگر خالی باشد از مختصات ساخته می‌شود",
        "اصفهان - خیابان آزادی",
        "وب",
    ],
    ...
    [
        "تاریخ پایان حمل",
        "اختیاری",
        "تاریخ شمسی پایان حمل مثل 1403-05-20؛ خالی بگذارید اگر ندارید",
        "",
        "وب (shipping_options)",
    ],
...
class SharedStrings:
    ...
    def to_xml(self) -> str:
        body = "".join(f'<si><t xml:space="preserve">{_xml_escape(item)}</t></si>' for item in self.items)
