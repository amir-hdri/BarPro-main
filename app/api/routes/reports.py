...
@router.get("/summary", summary="خلاصه آمار ربات", dependencies=[Depends(require_sensitive_admin)])
...
@router.get("/daily", summary="گزارش روزانه فعالیت", dependencies=[Depends(require_sensitive_admin)])
...
@router.get("/operational", summary="شاخص‌های عملیاتی", dependencies=[Depends(require_sensitive_admin)])
...
@router.get("/errors", summary="تحلیل خطاها", dependencies=[Depends(require_sensitive_admin)])
...
@router.get("/performance", summary="داشبورد عملکرد", dependencies=[Depends(require_sensitive_admin)])
