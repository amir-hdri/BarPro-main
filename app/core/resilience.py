...
from playwright.async_api import (
    Page, TimeoutError as PlaywrightTimeoutError,
    Error as PlaywrightError
)

from app.core.exceptions import UTCMSException, ErrorCode
...
class WorkflowState:
    ...
    def add_step(self, step_name: str, step_id: Optional[str] = None, max_attempts: int = 3) -> StepState:
    ...
    def get_failed_step(self) -> Optional[StepState]:
