...
class EnsembleSolver:
    ...
    @staticmethod
    def vote_best_solution(candidates: List[SolveCandidate], min_confidence: float = 0.6) -> Optional[str]:
    ...
    @staticmethod
    def consensus_filter(results: List[Tuple[str, float]], threshold: float = 0.7) -> Optional[str]:
