...
ALLOWED_TRANSITIONS: dict[str, set[str]] = {
    ...
    "running":        {"success", "failed", "needs_review", "waiting_retry", "otp_backoff", "unknown", "cancelled", "daily_limit_reached"},
    "in_progress":    {"success", "failed", "needs_review", "waiting_retry", "otp_backoff", "unknown", "cancelled", "daily_limit_reached"},
