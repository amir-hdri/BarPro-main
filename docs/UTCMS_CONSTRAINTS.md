...
- **مشاهده میدانی زنده 2026-09-25 (صدور قطعی دو بارنامه در ترنسپورت موبایل و کشف رفتارهای چرخه حمل):**
  ...
  - **قاعده خوداظهاری شروع حمل:** اسناد ثبت‌شده با مقداردهی `selfDeclaredTimeOfStartShipment` بلافاصله وضعیت `درحال حمل` (کد ۱) می‌گیرند. ارسال مجدد متد `RegisterStartOfShipping` با خطای بیزینسی ۴۰۰۶ («برای بارنامه نمی توان شروع حمل ثبت کرد») مواجه می‌شود.
  - **محدودیت تاریخ شروع حمل:** ثبت شروع حمل روی بارنامه‌های روزهای قبل با خطای ۴۰۱۳ («کاربر گرامی، ثبت شروع حمل، صرفا در همان روزی که بارنامه شهری صادر شده است امکان پذیر است») رد می‌شود.
  - **محاسبه تخمین زمان مقصد و ثبت پایان حمل:** سرور UTCMS بر اساس مختصات مبدأ و مقصد فیلد `estimatedTimeOfEndShipment` را درج می‌کند. فراخوانی `RegisterEndOfShipping` قبل از فرارسیدن این زمان با خطای ۴۰۱۱ رد می‌شود.
