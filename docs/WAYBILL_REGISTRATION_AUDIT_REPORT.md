...
> **نسخه سامانه:** BarPro (`commit: 8d6bd17` — این کامیت پس از v2.9.5 و درست پیش از v2.9.6 است؛ برچسب قدیمی «v2.9.4» نادرست بود)  
...
|---|---|---|---|---|---|
| **Central** | وب‌سرور، API، دیتابیس، ردیس، Beat، ورکر ۱ | `<CENTRAL_IP>` | ۱۶ کانتینر **Active / Healthy** | ۰.۱۹ ثانیه (پراکسی ۳۱۲۸) | ✅ Local Unix/TCP Bridge |
| **Worker 2** | اجرای پردازش RPA ۲ | `<WORKER_2_IP>` | ۲ کانتینر **Active / Healthy** | ۰.۱۶ ثانیه (پراکسی ۳۱۲۸) | ✅ اتصال به سنترال برقرار |
| **Worker 3** | اجرای پردازش RPA ۳ | `<WORKER_3_IP>` | ۲ کانتینر **Active / Healthy** | ۰.۱۶ ثانیه (پراکسی ۳۱۲۸) | ✅ اتصال به سنترال برقرار |
